...
configured default. To shift routine work toward one family while keeping an
independent cross-family review, follow [Balance agent families](references/unattended-run.md#balance-agent-families).
